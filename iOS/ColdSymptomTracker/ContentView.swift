...
struct ContentView: View {
    ...
    @State private var editingEntry: Check-inEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Cold Symptom Tracker")
            .toolbar {
    ...
    @ViewBuilder
    private func row(_ entry: Check-inEntry) -> some View {
...
struct EntrySheet: View {
    ...
    let entry: Check-inEntry?

    @State private var title: String = ""
    @State private var metric: Double = 5
    @State private var tag: String = ColdSymptomTrackerTags.all.first ?? ""
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Main symptom") {
                    Picker("Main symptom", selection: $tag) {
                        ForEach(ColdSymptomTrackerTags.all, id: \.self) { t in
                            Text(t).tag(t)
                        }
                    }
                    .pickerStyle(.menu)
            ...
            .navigationTitle(entry == nil ? "New Check-in" : "Edit Check-in")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let t = title.isEmpty ? "Check-in" : title
