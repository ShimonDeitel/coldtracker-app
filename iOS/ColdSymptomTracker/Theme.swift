...
/// Cold Symptom Tracker's identity: a palette built specifically for this app's domain
/// (check-in tracking) - not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.941, green: 0.957, blue: 0.933)
    static let card = Color.white
    static let cardBorder = Color(red: 0.361, green: 0.545, blue: 0.294).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 0.361, green: 0.545, blue: 0.294)
    static let accentDeep = Color(red: 0.235, green: 0.376, blue: 0.192)
